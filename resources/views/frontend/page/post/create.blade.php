            ...
            <div class="col-12">
                ...
                <form class="w-100" method="post" action="{{route('user.createPost')}}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input  required type="text" class="form-control" id="address_detail" placeholder="Enter address_detail"
                               name="address_detail">
                    </div>

                    <div class="mb-3 mt-3">
                        <label for="email">price</label>
                        <input  required type="text" class="form-control" id="price" placeholder="Enter price" name="price" data-type='currency'>
                    </div>
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input  required type="file" class="form-control" id="img"  name="img" onchange="preview()">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input  required type="text" class="form-control" id="deposit_amount" placeholder="Enter deposit_amount" data-type='currency'
                               name="deposit_amount">
                    </div>

{{--                    <div class="mb-3 mt-3">--}}
{{--                        <label for="email">status</label>--}}
{{--                        --}}{{--                    <input  required type="text" class="form-control" id="status" placeholder="Enter status" name="status">--}}
...
{{--                    </div>--}}
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input  required type="text" class="form-control" id="created_by" placeholder="Enter created_by"
                               name="created_by">
                    </div>
